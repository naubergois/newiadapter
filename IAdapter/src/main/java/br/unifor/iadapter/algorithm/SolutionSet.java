...
public class SolutionSet implements Serializable {
   ...
   */
  protected final List<WorkLoad> solutionsList_;
   ...
   */
  public SolutionSet() {
    solutionsList_ = new ArrayList<WorkLoad>();
  } // SolutionSet
   ...
   * otherwise. 
   */
  public boolean add(WorkLoad solution) {
  ...
  public boolean add(int index, WorkLoad solution) {
  ...
  */
   ...
   */
   int indexBest(Comparator comparator){
    ...
    int index = 0; 
    WorkLoad bestKnown = solutionsList_.get(0), candidateSolution;
    int flag;
   ...
   */
  public WorkLoad best(Comparator comparator){
  ...
  public int indexWorst(Comparator comparator){
    ...
    int index = 0;
    WorkLoad worstKnown = solutionsList_.get(0), candidateSolution;
    int flag;
    for (int i = 1; i < solutionsList_.size(); i++) {        
      candidateSolution = solutionsList_.get(i);
   ...
   * if the SolutionSet is empty
   */
  public WorkLoad worst(Comparator comparator){
   ...
   */    
  public Iterator<WorkLoad> iterator(){
   ...
   */
  public void replace(int position, WorkLoad solution) {
