...
class ProblemConfiguration implements MaxMinConfigurationProvider, AcsConfigurationProvider {

	// private static final String FILE_NAME = "flowshop_default.data";
	private static final String FILE_NAME = "ta001.data";

	private static final String FILE_FOLDER = "C:/Users/Carlos G. Gavidia/git/aco-flowshop/src/";
	...
	public ProblemConfiguration(double[][] problemRepresentation) {
		...
		System.out.println("Problem Representtion: "+problemRepresentation);
		double randomQuality = AntForFlowShop
				.getBestFit(randomSolution.toArray(new Integer[randomSolution.size()]), problemRepresentation);
	...
	public double getMaximumPheromoneValue() {
		throw new ConfigurationException("We don't use this parameter in this version of the Algorithm");
	}
	...
	public double getBestChoiceProbability() {
		...
		double bestChoiceProbability = (problemGraph.length - this.getBestChoiceConstant()) / problemGraph.length;
